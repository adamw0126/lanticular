                                    ...
                                    <div id="w-node-_03bd3d16-fd9e-51dd-4083-176ce369b92f-7b225824" className="motion-element">
                                        <div className="motion-wrapper">
                                            ...
                                            <div className="motion_3d-wrapper">
                                                {
                                                    is2D ? <img sizes="(max-width: 479px) 100vw, (max-width: 767px) 97vw, (max-width: 991px) 90vw, 91vw" srcSet="./anim_2.mp4 500w, ./anim_2.mp4 800w, ./anim_2.mp4 1024w" alt="Lenticular" src="./cat.jpg" loading="eager" className="motion_img-2d"/> :
                                            ...
                                            <div className="motion_2d-wrapper">
                                                <img sizes="(max-width: 479px) 100vw, (max-width: 767px) 97vw, (max-width: 991px) 90vw, 91vw" srcSet="./cat.jpg 500w, ./cat.jpg 800w, ./cat.jpg 1024w" alt="Lenticular" src="./cat.jpg" loading="eager" className="motion_img-2d"/>
                                            </div>
                                        </div>
