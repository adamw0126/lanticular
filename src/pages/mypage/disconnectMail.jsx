...
import EditPassword from './disconnEditPass';

const DisconnectMail = ({ open, onClose }) => {
    ...
    return (
        ...
        >
            ...
            {/* <EditPassword openEdit={isEdit} onCloseEdit={() => setIsEdit(false)} /> */}
        </Dialog>
    );
};

export default DisconnectMail;
